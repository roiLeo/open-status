...
function isMobileOrTablet(a: string) {
  return REGEX_MOBILE_OR_TABLET1.test(a) || REGEX_MOBILE_OR_TABLET2.test(a.substr(0, 4))
}

function isIos(a: string) {
  return /iPad|iPhone|iPod/.test(a)
}

function isAndroid(a: string) {
  return /android/i.test(a)
}

function isWindows(a: string) {
  return /Windows/.test(a)
}

function isMacOS(a: string) {
...
function extractDevices(ctx, userAgent: string) {
  let mobile = null
...
const makeFlags = (ctx: Record<string, any>) => {
  let userAgent = ''
